---
layout: publication
title: 'Exploring The Potential Of Chatgpt In Automated Code Refinement: An Empirical
  Study'
authors: Guo et al.
conference: Proceedings of the IEEE/ACM 46th International Conference on Software
  Engineering
year: 2023
bibkey: guo2023exploring
citations: 59
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2309.08221'}]
tags: [Model Architecture, LLM For Code, Evaluation, LLM for Code, GPT, Datasets]
---
