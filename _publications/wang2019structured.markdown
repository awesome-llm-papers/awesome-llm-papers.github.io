...
tags: [Training Techniques, EMNLP, Evaluation, BERT, Model Architecture, Efficiency
    And Optimization, Language Modeling, Quantization, Fine Tuning, Pruning, Datasets]
---
