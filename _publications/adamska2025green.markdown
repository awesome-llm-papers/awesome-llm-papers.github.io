...
authors: Adamska et al.
conference: Journal of Environmental Planning and Management
year: 2025
bibkey: adamska2025green
citations: 144
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2503.10666'}]
tags: [RAG, Prompting, Transformer, Model Architecture, Efficiency And Optimization,
  Language Modeling, Fine Tuning, LLM For Code]
---
