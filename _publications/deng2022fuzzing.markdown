...
year: 2022
bibkey: deng2022fuzzing
citations: 54
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2207.05531'}]
tags: [Tools, Training Techniques, LLM For Code, Evaluation, LLM for Code]
---
...
162 code bugs, we have also detected 14 documentation bugs (all confirmed).