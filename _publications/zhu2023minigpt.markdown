...
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2304.10592v2'}, {name: Code,
    url: 'https://minigpt-4.github.io/'}]
tags: [Has Code, Model Architecture, RAG, Reinforcement Learning, Multimodal Models,
  GPT, Merging]
---
