---
layout: publication
title: Evaluation Is All You Need. Prompting Generative Large Language Models For
  Annotation Tasks In The Social Sciences. A Primer Using Open Models
...
citations: 78
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2401.00284'}]
tags: [Prompting, LLM For Code, Evaluation, LLM for Code, Reinforcement Learning]
---
