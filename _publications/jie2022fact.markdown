...
authors: Jie Shibo, Deng Zhi-hong
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2022
bibkey: jie2022fact
citations: 50
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2212.03145'}]
tags: [RAG, Training Techniques, Tools, Evaluation, Transformer, Model Architecture,
  Few Shot, Efficiency And Optimization, Reinforcement Learning, Applications, Fine
    Tuning, AAAI, Datasets]
---
