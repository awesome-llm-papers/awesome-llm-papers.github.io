...
year: 2023
citations: 32
bibkey: ishmam2023from
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2311.00308'}]
tags: [Model Architecture, Survey Paper, Reinforcement Learning, Multimodal Models,
  Pre-Training, Training Techniques, Merging]
---
The multimodal task of Visual Question Answering (VQA) encompassing elements
