...
authors: Tianyu Yu, Yuan Yao, Haoye Zhang, Taiwen He, Yifeng Han, Ganqu Cui, Jinyi
  Hu, Zhiyuan Liu, Hai-tao Zheng, Maosong Sun, Tat-seng Chua
conference: Arxiv
year: 2023
bibkey: tianyu2023rlhf
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2312.00849v2'}]
tags: [Model Architecture, Multimodal Models, Evaluation, Efficiency And Optimization,
  Datasets, Reinforcement Learning, Applications, GPT, Security]
---
