...
authors: Kreutzer Julia, Bastings Jasmijn, Riezler Stefan
...
citations: 90
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1907.12484'}]
tags: [EMNLP, Evaluation, Transformer, Model Architecture, Reinforcement Learning,
  Datasets]
---
