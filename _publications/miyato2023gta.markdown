...
year: 2023
bibkey: miyato2023gta
citations: 89
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2310.10375'}]
tags: [Attention Mechanism, CVPR, Transformer, Model Architecture, Efficiency And
    Optimization, Reinforcement Learning, Datasets]
---
As transformers are equivariant to the permutation of input tokens, encoding
