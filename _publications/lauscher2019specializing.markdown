...
authors: Lauscher et al.
conference: Proceedings of the 28th International Conference on Computational Linguistics
year: 2019
bibkey: lauscher2019specializing
citations: 51
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1909.02339'}]
tags: [Training Techniques, Masked Language Model, COLING, Evaluation, BERT, Model
    Architecture, Language Modeling, Applications, Datasets]
---
Unsupervised pretraining models have been shown to facilitate a wide range of
