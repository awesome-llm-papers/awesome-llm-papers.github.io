...
authors: Shukang et al.
conference: National Science Review
year: 2023
bibkey: shukang2023survey
citations: 107
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2306.13549v2'}]
tags: [Model Architecture, Training Techniques, Survey Paper, Evaluation, LLM for
    Code, GPT, Multimodal Models, Reinforcement Learning]
---
