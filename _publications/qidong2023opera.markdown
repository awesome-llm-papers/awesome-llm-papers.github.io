...
authors: Qidong Huang, Xiaoyi Dong, Pan Zhang, Bin Wang, Conghui He, Jiaqi Wang, Dahua
  Lin, Weiming Zhang, Nenghai Yu
conference: Arxiv
year: 2023
bibkey: qidong2023opera
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2311.17911v3'}]
tags: [Model Architecture, Attention Mechanism, Evaluation, Transformer, Reinforcement
    Learning, Alt, Training Techniques]
---
