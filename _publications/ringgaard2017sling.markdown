...
authors: Ringgaard Michael, Gupta Rahul, Pereira Fernando C. N.
conference: Computational Linguistics
year: 2017
bibkey: ringgaard2017sling
citations: 97
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1710.07032'}]
tags: [Model Architecture, Tools, TACL, ACL, Reinforcement Learning, NAACL, EACL,
  COLING]
---
