...
authors: Freda Shi, Mirac Suzgun, Markus Freitag, Xuezhi Wang, Suraj Srivats, Soroush
  Vosoughi, Hyung Won Chung, Yi Tay, Sebastian Ruder, Denny Zhou, Dipanjan Das, Jason
  Wei
conference: Arxiv
year: 2022
bibkey: freda2022language
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2210.03057v1'}]
tags: [Datasets, Reinforcement Learning, Evaluation, Prompting]
---
