...
authors: Tianyang Han, Qing Lian, Rui Pan, Renjie Pi, Jipeng Zhang, Shizhe Diao, Yong
  Lin, Tong Zhang
conference: Arxiv
year: 2024
bibkey: tianyang2024instinctive
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2402.03757v1'}]
tags: [Model Architecture, Evaluation, Datasets, GPT, Reinforcement Learning, Ethics
    And Bias, Security]
---
