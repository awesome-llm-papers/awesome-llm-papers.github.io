...
authors: Timin Gao, Peixian Chen, Mengdan Zhang, Chaoyou Fu, Yunhang Shen, Yan Zhang,
  Shengchuan Zhang, Xiawu Zheng, Xing Sun, Liujuan Cao, Rongrong Ji
conference: Arxiv
year: 2024
bibkey: timin2024cantor
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2404.16033v1'}]
tags: [Model Architecture, Multimodal Models, Fine Tuning, Datasets, Tools, RAG, Training
    Techniques]
---
