...
bibkey: xu2024slmrec
citations: 56
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2405.17890'}]
tags: [Pruning, Distillation, Tools, Training Techniques, Efficiency And Optimization,
  RecSys, Quantization, RAG, Datasets, Reinforcement Learning, Language Modeling,
  Alt]
---
