...
authors: Zhenrui Yue, Sara Rabhi, Gabriel de Souza Pereira Moreira, Dong Wang, Even
  Oldridge
conference: Arxiv
year: 2023
bibkey: zhenrui2023llamarec
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2311.02089v1'}]
tags: [Evaluation, Efficiency And Optimization, Datasets, Tools, RAG, GPT, Prompting,
  Training Techniques]
---
