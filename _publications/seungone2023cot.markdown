...
authors: Seungone Kim, Se June Joo, Doyoung Kim, Joel Jang, Seonghyeon Ye, Jamin Shin,
  Minjoon Seo
conference: Arxiv
year: 2023
bibkey: seungone2023cot
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.14045v2'}]
tags: [Model Architecture, Evaluation, Few Shot, Fine Tuning, Datasets, Reinforcement
    Learning, RAG, GPT, Training Techniques]
---
