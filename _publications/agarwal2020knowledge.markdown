---
layout: publication
title: Knowledge Graph Based Synthetic Corpus Generation For Knowledge-enhanced Language
  Model Pre-training
authors: Agarwal et al.
conference: 'Proceedings of the 2021 Conference of the North American Chapter of the
  Association for Computational Linguistics: Human Language Technologies'
year: 2020
bibkey: agarwal2020knowledge
citations: 113
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2010.12688'}]
tags: [Model Architecture, Training Techniques, Evaluation, ACL, NAACL, Datasets,
  Language Modeling]
---
