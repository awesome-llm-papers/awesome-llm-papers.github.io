...
conference: Institute of Electrical and Electronics Engineers (IEEE)
year: 2020
citations: 62
bibkey: fang2020contrastive
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2005.12766'}, {name: Code,
    url: 'https://github.com/UCSD-AI4H/CERT'}]
tags: [Has Code, Model Architecture, GPT, Transformer, RAG, BERT, Training Techniques,
  Evaluation]
---
