...
conference: Arxiv
year: 2018
bibkey: zhang2018next
citations: 70
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1808.06414'}]
tags: [Attention Mechanism, Tools, Transformer, Model Architecture, Datasets]
---
In this paper, we propose a novel sequence-aware recommendation model. Our
