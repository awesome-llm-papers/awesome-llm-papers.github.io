...
title: 'Summareranker: A Multi-task Mixture-of-experts Re-ranking Framework For Abstractive
  Summarization'
authors: Ravaut Mathieu, Joty Shafiq, Chen Nancy F.
conference: 'Proceedings of the 60th Annual Meeting of the Association for Computational
  Linguistics (Volume 1: Long Papers)'
year: 2022
bibkey: ravaut2022summareranker
citations: 59
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2203.06569'}]
tags: [Ethics And Bias, Tools, Fine Tuning, Training Techniques, ACL, Datasets]
---
