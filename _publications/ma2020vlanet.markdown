---
layout: publication
title: 'Vlanet: Video-language Alignment Network For Weakly-supervised Video Moment
  Retrieval'
authors: Ma et al.
...
bibkey: ma2020vlanet
citations: 68
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2008.10238'}]
tags: [RAG, Training Techniques, Attention Mechanism, Transformer, Model Architecture,
  Efficiency And Optimization, Multimodal Models, Pruning, Datasets]
---
