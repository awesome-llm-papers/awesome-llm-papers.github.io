---
layout: publication
title: Reducing Gender Bias In Word-level Language Models With A Gender-equalizing
  Loss Function
authors: Qian et al.
conference: 'Proceedings of the 57th Annual Meeting of the Association for Computational
  Linguistics: Student Research Workshop'
year: 2019
bibkey: qian2019reducing
citations: 60
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1905.12801'}]
tags: [Ethics And Bias, Evaluation, ACL, Datasets, Language Modeling]
---
Gender bias exists in natural language datasets which neural language models
