...
title: Plan, Eliminate, And Track -- Language Models Are Good Teachers For Embodied
  Agents
authors: Yue Wu, So Yeon Min, Yonatan Bisk, Ruslan Salakhutdinov, Amos Azaria, Yuanzhi
  Li, Tom Mitchell, Shrimai Prabhumoye
conference: Arxiv
year: 2023
bibkey: yue2023plan
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.02412v2'}]
tags: [Model Architecture, Evaluation, Agentic, Fine Tuning, Efficiency And Optimization,
  Transformer, Datasets, Tools, RAG, Reinforcement Learning, Ethics And Bias, Training
    Techniques]
---
