...
authors: Jianghao Lin, Xinyi Dai, Yunjia Xi, Weiwen Liu, Bo Chen, Hao Zhang, Yong
  Liu, Chuhan Wu, Xiangyang Li, Chenxu Zhu, Huifeng Guo, Yong Yu, Ruiming Tang, Weinan
  Zhang
conference: Arxiv
year: 2023
bibkey: jianghao2023how
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2306.05817v6'}]
tags: [Efficiency And Optimization, Tools, Reinforcement Learning, Ethics And Bias,
  Training Techniques]
---
