...
authors: Shibo Hao, Yi Gu, Haodi Ma, Joshua Jiahua Hong, Zhen Wang, Daisy Zhe Wang,
  Zhiting Hu
conference: Arxiv
year: 2023
bibkey: shibo2023reasoning
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.14992v2'}]
tags: [Model Architecture, Agentic, Fine Tuning, GPT, Tools, Alt, Reinforcement Learning,
  Prompting]
---
