...
authors: Teng Wang, Jinrui Zhang, Junjie Fei, Hao Zheng, Yunlong Tang, Zhe Li, Mingqi
  Gao, Shanshan Zhao
conference: Arxiv
year: 2023
bibkey: teng2023caption
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.02677v3'}]
tags: [Model Architecture, Multimodal Models, GPT, Tools, RAG, Alt, Reinforcement
    Learning, Applications, Merging, Prompting]
---
