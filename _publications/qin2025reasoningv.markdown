---
layout: publication
title: 'Reasoningv: Efficient Verilog Code Generation With Adaptive Hybrid Reasoning
  Model'
authors: Qin et al.
conference: ACM Transactions on Design Automation of Electronic Systems
year: 2025
bibkey: qin2025reasoningv
citations: 71
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2504.14560'}]
tags: [Training Techniques, Tools, Efficiency And Optimization, Fine Tuning, Datasets,
  LLM For Code]
---
