...
year: 2023
bibkey: zhang2023finemogen
citations: 60
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2312.15004'}]
tags: [ICCV, Attention Mechanism, Tools, Transformer, Model Architecture, Datasets,
  Merging]
---
Text-driven motion generation has achieved substantial progress with the
