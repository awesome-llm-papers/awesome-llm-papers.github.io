---
layout: publication
title: A Comprehensive Survey Of Hallucination Mitigation Techniques In Large Language
  Models
...
tags: [RAG, Training Techniques, Prompting, Ethics And Bias, Survey Paper, Reinforcement
