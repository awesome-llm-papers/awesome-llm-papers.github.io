...
authors: Barnes Jeremy, Klinger Roman, Walde Sabine Schulte Im
conference: Proceedings of the 8th Workshop on Computational Approaches to Subjectivity,
  Sentiment and Social Media Analysis
year: 2017
bibkey: barnes2017assessing
citations: 65
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1709.04219'}]
tags: [Training Techniques, Evaluation, Model Architecture, Reinforcement Learning,
  Datasets]
---
