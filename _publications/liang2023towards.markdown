...
authors: Liang Chen, Yichi Zhang, Shuhuai Ren, Haozhe Zhao, Zefan Cai, Yuchi Wang,
  Peiyi Wang, Tianyu Liu, Baobao Chang
conference: Arxiv
year: 2023
bibkey: liang2023towards
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2310.02071v4'}]
tags: [Model Architecture, Multimodal Models, Evaluation, Agentic, Fine Tuning, Datasets,
  Tools, RAG, Reinforcement Learning, GPT]
---
