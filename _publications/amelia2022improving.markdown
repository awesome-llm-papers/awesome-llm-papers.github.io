...
authors: "Amelia Glaese, Nat Mcaleese, Maja Tr\u0119bacz, John Aslanides, Vlad Firoiu,\
  ...
  \ Sanchez Elias, Richard Green, So\u0148a Mokr\xE1, Nicholas Fernando, Boxi Wu,\
  \ Rachel Foley, Susannah Young, Iason Gabriel, William Isaac, John Mellor, Demis\
  \ Hassabis, Koray Kavukcuoglu, Lisa Anne Hendricks, Geoffrey Irving"
conference: Arxiv
year: 2022
bibkey: amelia2022improving
citations: 107
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2209.14375v1'}]
tags: [Agentic, Prompting, Reinforcement Learning, Ethics And Bias, Security]
---
