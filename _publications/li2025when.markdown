...
authors: Li et al.
conference: Journal of the Experimental Analysis of Behavior
year: 2025
bibkey: li2025when
citations: 69
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2505.04741'}]
tags: [Training Techniques, Alt, Prompting, Evaluation]
---
In large language model (LLM) pretraining, data quality is believed to
