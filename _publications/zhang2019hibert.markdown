---
layout: publication
title: 'HIBERT: Document Level Pre-training Of Hierarchical Bidirectional Transformers
  For Document Summarization'
authors: Zhang Xingxing, Wei Furu, Zhou Ming
conference: Proceedings of the 57th Annual Meeting of the Association for Computational
  Linguistics
year: 2019
bibkey: zhang2019hibert
citations: 365
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1905.06566'}]
tags: [Model Architecture, Training Techniques, BERT, ACL, Transformer, Datasets]
---
...
encoder with these *inaccurate* labels is challenging. Inspired by the
