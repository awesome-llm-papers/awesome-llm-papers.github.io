...
authors: Hsu Cheng, Li Cheng-te
conference: Proceedings of the Web Conference 2021
year: 2021
bibkey: hsu2021retagnn
citations: 73
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2101.12457'}]
tags: [Interpretability And Explainability, Training Techniques, Attention Mechanism,
  Transformer, Model Architecture, Reinforcement Learning, Datasets]
---
Sequential recommendation (SR) is to accurately recommend a list of items for
