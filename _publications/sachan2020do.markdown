...
authors: Sachan et al.
conference: Arxiv
year: 2020
bibkey: sachan2020do
citations: 57
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2008.09084'}]
tags: [Attention Mechanism, Transformer, BERT, Model Architecture, Reinforcement Learning,
  Applications, Merging]
---
Much recent work suggests that incorporating syntax information from
