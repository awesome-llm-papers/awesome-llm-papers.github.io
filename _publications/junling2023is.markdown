...
authors: Junling et al.
conference: Proceedings of the 4th New Frontiers in Summarization Workshop
year: 2023
bibkey: junling2023is
citations: 99
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2304.10149v3'}]
tags: [Interpretability And Explainability, GPT, Prompting, Evaluation, In Context
    Learning, Model Architecture, Few Shot, Reinforcement Learning, Datasets]
---
