...
citations: 469
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2104.12763'}]
tags: [ICCV, Training Techniques, Evaluation, Transformer, Model Architecture, Few
    Shot, Reinforcement Learning, Datasets]
---
