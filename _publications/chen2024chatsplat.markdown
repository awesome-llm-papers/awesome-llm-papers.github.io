...
authors: Chen Hanlin, Wei Fangyin, Lee Gim Hee
conference: 2024 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2024
bibkey: chen2024chatsplat
citations: 85
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2412.00734'}]
tags: [CVPR, Reinforcement Learning]
---
Humans naturally interact with their 3D surroundings using language, and
