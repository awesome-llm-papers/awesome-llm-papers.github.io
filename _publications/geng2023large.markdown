---
layout: publication
title: 'Large Language Models Are Few-shot Summarizers: Multi-intent Comment Generation
  Via In-context Learning'
authors: Geng et al.
conference: Proceedings of the IEEE/ACM 46th International Conference on Software
  Engineering
year: 2023
bibkey: geng2023large
citations: 71
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2304.11384'}]
tags: [Prompting, Training Techniques, LLM For Code, Few Shot, In Context Learning,
