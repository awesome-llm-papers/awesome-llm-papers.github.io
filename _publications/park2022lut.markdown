---
layout: publication
title: 'LUT-GEMM: Quantized Matrix Multiplication Based On Luts For Efficient Inference
  In Large-scale Generative Language Models'
...
the costly dequantization process.