...
authors: Burtsev et al.
conference: 2020 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2020
bibkey: burtsev2020memory
citations: 965
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2006.11527'}]
tags: [Attention Mechanism, Masked Language Model, Evaluation, CVPR, BERT, Transformer,
  Model Architecture, Language Modeling, Datasets]
---
