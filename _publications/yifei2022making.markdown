...
authors: Yifei Li, Zeqi Lin, Shizhuo Zhang, Qiang Fu, Bei Chen, Jian-guang Lou, Weizhu
  Chen
conference: Arxiv
year: 2022
bibkey: yifei2022making
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2206.02336v3'}]
tags: [Model Architecture, Evaluation, Few Shot, Datasets, Prompting, GPT]
---
