---
layout: publication
title: Using Complex Prompts To Identify Fine-grained Biases In Image Generation Through
  Chatgpt-4o
authors: Ferreira Marinus
conference: 2017 IEEE International Conference on Computer Vision (ICCV)
year: 2025
bibkey: ferreira2025using
citations: 399
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2504.00388'}]
tags: [ICCV, Training Techniques, GPT, Alt, Prompting, Ethics And Bias, Model Architecture,
  Reinforcement Learning, Datasets]
---
There are not one but two dimensions of bias that can be revealed through the
