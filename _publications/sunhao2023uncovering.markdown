...
authors: Sunhao Dai, Ninglu Shao, Haiyuan Zhao, Weijie Yu, Zihua Si, Chen Xu, Zhongxiang
  Sun, Xiao Zhang, Jun Xu
conference: Proceedings of the 17th ACM Conference on Recommender Systems
year: 2023
bibkey: sunhao2023uncovering
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.02182v3'}]
tags: [Attention Mechanism, Prompting, Fine Tuning, Model Architecture, GPT, Datasets,
  RecSys]
---
