...
authors: Junyang Wang, Yiyang Zhou, Guohai Xu, Pengcheng Shi, Chenlin Zhao, Haiyang
  Xu, Qinghao Ye, Ming Yan, Ji Zhang, Jihua Zhu, Jitao Sang, Haoyu Tang
conference: Arxiv
year: 2023
bibkey: junyang2023evaluation
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2308.15126v3'}]
tags: [Model Architecture, Multimodal Models, Evaluation, GPT, Tools, RAG, Training
    Techniques]
---
