...
year: 2020
bibkey: gao2020generating
citations: 56
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2005.10157'}]
tags: [Model Architecture, Evaluation, LLM For Code, LLM for Code, Transformer, RAG,
  Datasets, Reinforcement Learning, Attention Mechanism]
---
Stack Overflow has been heavily used by software developers as a popular way
