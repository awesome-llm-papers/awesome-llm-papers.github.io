...
authors: Yaru Hao, Haoyu Song, Li Dong, Shaohan Huang, Zewen Chi, Wenhui Wang, Shuming
  Ma, Furu Wei
conference: Arxiv
year: 2022
bibkey: yaru2022language
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2206.06336v1'}]
tags: [Model Architecture, Attention Mechanism, Multimodal Models, Few Shot, Language
    Modeling, Evaluation, Datasets, Reinforcement Learning, Applications, In Context
    Learning]
---
