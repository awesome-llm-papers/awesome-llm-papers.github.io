---
layout: publication
title: Synchronous Speech Recognition And Speech-to-text Translation With Interactive
  Decoding
authors: Yuchen Liu, Jiajun Zhang, Hao Xiong, Long Zhou, Zhongjun He, Hua Wu, Haifeng
  Wang, Chengqing Zong
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2020
bibkey: liu2019synchronous
citations: 60
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1912.07240'}]
tags: ["AAAI"]
short_authors: Liu et al.
---
Speech-to-text translation (ST), which translates source language speech into
