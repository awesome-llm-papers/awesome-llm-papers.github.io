...
authors: Qing Lyu, Shreya Havaldar, Adam Stein, Li Zhang, Delip Rao, Eric Wong, Marianna
  Apidianaki, Chris Callison-burch
conference: Arxiv
year: 2023
bibkey: qing2023faithful
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2301.13379v3'}]
tags: [Model Architecture, Evaluation, Few Shot, Datasets, Tools, GPT, Prompting,
