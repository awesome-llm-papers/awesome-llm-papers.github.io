...
authors: Shuohuan Wang, Yu Sun, Yang Xiang, Zhihua Wu, Siyu Ding, Weibao Gong, Shikun
  Feng, Junyuan Shang, Yanbin Zhao, Chao Pang, Jiaxiang Liu, Xuyi Chen, Yuxiang Lu,
  Weixin Liu, Xi Wang, Yangfan Bai, Qiuliang Chen, Li Zhao, Shiyong Li, Peng Sun,
  Dianhai Yu, Yanjun Ma, Hao Tian, Hua Wu, Tian Wu, Wei Zeng, Ge Li, Wen Gao, Haifeng
  Wang
conference: Arxiv
year: 2021
bibkey: shuohuan2021ernie
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2112.12731v1'}]
tags: [Model Architecture, Language Modeling, Efficiency And Optimization, Datasets,
  Tools, GPT, Training Techniques, Security]
---
