...
conference: Arxiv
year: 2024
bibkey: yichuan2024mend
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2403.06914v2'}]
tags: [Model Architecture, Attention Mechanism, Evaluation, Fine Tuning, Efficiency
    And Optimization, Transformer, GPT, In Context Learning, Training Techniques]
---
