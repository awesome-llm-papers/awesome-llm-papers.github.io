...
authors: Chenglei et al.
conference: Arxiv
year: 2022
bibkey: chenglei2022prompting
citations: 62
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2210.09150v2'}]
tags: [Datasets, GPT, Prompting, Tools, Evaluation, Ethics And Bias, Model Architecture,
  Few Shot, Reinforcement Learning, Applications, Responsible AI]
---
