...
authors: Huang et al.
conference: British Journal of Nutrition
year: 2024
bibkey: huang2024dishonesty
citations: 68
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2406.01931'}]
tags: [GPT, Agentic, Tools, Model Architecture, Reinforcement Learning]
---
People tell lies when seeking rewards. Large language models (LLMs) are
