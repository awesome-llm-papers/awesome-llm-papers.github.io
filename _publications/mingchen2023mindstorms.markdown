...
authors: "Mingchen Zhuge, Haozhe Liu, Francesco Faccio, Dylan R. Ashley, R\xF3bert\
  \ Csord\xE1s, Anand Gopalakrishnan, Abdullah Hamdi, Hasan Abed Al Kader Hammoud,\
  \ Vincent Herrmann, Kazuki Irie, Louis Kirsch, Bing Li, Guohao Li, Shuming Liu,\
  \ Jinjie Mai, Piotr Pi\u0119kos, Aditya Ramesh, Imanol Schlag, Weimin Shi, Aleksandar\
  \ Stani\u0107, Wenyi Wang, Yuhui Wang, Mengmeng Xu, Deng-ping Fan, Bernard Ghanem,\
  \ J\xFCrgen Schmidhuber"
conference: Arxiv
year: 2023
bibkey: mingchen2023mindstorms
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.17066v1'}]
tags: [Reinforcement Learning, RAG, Multimodal Models, Agentic]
---
