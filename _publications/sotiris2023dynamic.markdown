...
authors: Sotiris Anagnostidis, Dario Pavllo, Luca Biggio, Lorenzo Noci, Aurelien Lucchi,
  Thomas Hofmann
conference: Arxiv
year: 2023
bibkey: sotiris2023dynamic
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.15805v3'}]
tags: [Model Architecture, Attention Mechanism, Fine Tuning, Efficiency And Optimization,
  Transformer, GPT, Interpretability And Explainability, Training Techniques]
---
