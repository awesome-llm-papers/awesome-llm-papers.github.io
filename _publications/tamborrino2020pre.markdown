...
authors: Tamborrino et al.
conference: Proceedings of the 58th Annual Meeting of the Association for Computational
  Linguistics
year: 2020
bibkey: tamborrino2020pre
citations: 55
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2004.14074'}]
tags: [Masked Language Model, Model Architecture, Training Techniques, Fine Tuning,
  BERT, ACL, Transformer, RAG, Datasets, Language Modeling]
---
