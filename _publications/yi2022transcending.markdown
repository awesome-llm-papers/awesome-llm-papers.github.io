...
authors: Yi Tay, Jason Wei, Hyung Won Chung, Vinh Q. Tran, David R. So, Siamak Shakeri,
  Xavier Garcia, Huaixiu Steven Zheng, Jinfeng Rao, Aakanksha Chowdhery, Denny Zhou,
  Donald Metzler, Slav Petrov, Neil Houlsby, Quoc V. Le, Mostafa Dehghani
conference: Arxiv
year: 2022
bibkey: yi2022transcending
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2210.11399v2'}]
tags: [Evaluation, Few Shot, Efficiency And Optimization, Reinforcement Learning,
  Training Techniques]
---
