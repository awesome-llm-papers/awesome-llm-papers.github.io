...
title: 'Spatten: Efficient Sparse Attention Architecture With Cascade Token And Head
  Pruning'
authors: Wang Hanrui, Zhang Zhekai, Han Song
...
tags: [RAG, Attention Mechanism, Evaluation, Transformer, Model Architecture, Efficiency
    And Optimization, Reinforcement Learning, Applications, Quantization, Pruning,
  Datasets]
---
