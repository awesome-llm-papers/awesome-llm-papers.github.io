---
layout: publication
title: Investigating Explainability Of Generative AI For Code Through Scenario-based
  Design
authors: Sun et al.
...
citations: 141
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2202.04903'}]
tags: [Interpretability And Explainability, Attention Mechanism, Model Architecture,
  Applications, LLM For Code]
---
