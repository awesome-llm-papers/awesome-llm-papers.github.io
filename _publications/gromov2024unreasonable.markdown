...
authors: Gromov et al.
conference: Cambridge Journal of Economics
year: 2024
bibkey: gromov2024unreasonable
citations: 64
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2403.17887'}]
tags: [RAG, Training Techniques, Evaluation, Efficiency And Optimization, Reinforcement
    Learning, Security, Quantization, Fine Tuning, Pruning, Datasets]
---
How is knowledge stored in an LLM's weights? We study this via layer pruning:
