...
conference: Proceedings of the 2022 Conference on Empirical Methods in Natural Language
  Processing
year: 2022
bibkey: yiming2022active
citations: 52
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2211.04486v1'}]
tags: [RAG, EMNLP, Training Techniques, GPT, Agentic, In Context Learning, Model Architecture,
  Reinforcement Learning, Fine Tuning, Merging]
---
