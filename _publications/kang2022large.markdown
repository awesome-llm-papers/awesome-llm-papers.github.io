...
title: 'Large Language Models Are Few-shot Testers: Exploring Llm-based General Bug
  Reproduction'
authors: Kang Sungmin, Yoon Juyeon, Yoo Shin
...
tags: [Tools, Training Techniques, Efficiency And Optimization, Fine Tuning, Evaluation,
  LLM For Code, Few Shot, LLM for Code, RAG, Datasets]
---
