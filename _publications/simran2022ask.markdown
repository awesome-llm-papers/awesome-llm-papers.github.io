...
authors: "Simran Arora, Avanika Narayan, Mayee F. Chen, Laurel Orr, Neel Guha, Kush\
  \ Bhatia, Ines Chami, Frederic Sala, Christopher R\xE9"
conference: Arxiv
year: 2022
bibkey: simran2022ask
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2210.02441v3'}]
tags: [Model Architecture, Evaluation, Few Shot, Datasets, GPT, RAG, Prompting, Training
    Techniques]
---
