...
authors: Zhiwei He, Tian Liang, Wenxiang Jiao, Zhuosheng Zhang, Yujiu Yang, Rui Wang,
  Zhaopeng Tu, Shuming Shi, Xing Wang
conference: Arxiv
year: 2023
bibkey: zhiwei2023exploring
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.04118v3'}]
tags: [Model Architecture, Attention Mechanism, Evaluation, Prompting, Tools]
---
