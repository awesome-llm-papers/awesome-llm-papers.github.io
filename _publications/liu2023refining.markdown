---
layout: publication
title: 'Refining Chatgpt-generated Code: Characterizing And Mitigating Code Quality
  Issues'
authors: Liu et al.
conference: ACM Transactions on Software Engineering and Methodology
year: 2023
bibkey: liu2023refining
citations: 58
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2307.12596'}]
tags: [Model Architecture, Tools, LLM For Code, LLM for Code, GPT, Reinforcement Learning]
---
We systematically study the quality of 4,066 ChatGPT-generated code
