...
citations: 246
bibkey: liu2021p
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2110.07602v3'}, {name: Code,
    url: 'https://github.com/THUDM/P-tuning-v2'}]
tags: [Training Techniques, RAG, Fine-Tuning, Reinforcement Learning, Has Code, Prompting]
---
