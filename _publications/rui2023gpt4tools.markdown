...
conference: Arxiv
year: 2023
bibkey: rui2023gpt4tools
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.18752v1'}]
tags: [Model Architecture, Multimodal Models, Evaluation, Fine Tuning, Efficiency
    And Optimization, Datasets, Tools, GPT, Prompting, Training Techniques]
---
