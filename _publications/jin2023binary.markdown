---
layout: publication
title: 'Binary Code Summarization: Benchmarking Chatgpt/gpt-4 And Other Large Language
  Models'
authors: Jin et al.
...
citations: 142
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2312.09601'}]
tags: [Model Architecture, Prompting, Efficiency And Optimization, Evaluation, TACL,
  LLM For Code, ACL, GPT, Datasets]
---
