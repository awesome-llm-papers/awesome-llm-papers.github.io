...
title: 'Prompt, Generate, Then Cache: Cascade Of Foundation Models Makes Strong Few-shot
  Learners'
authors: Renrui Zhang, Xiangfei Hu, Bohao Li, Siyuan Huang, Hanqiu Deng, Hongsheng
  Li, Yu Qiao, Peng Gao
conference: Arxiv
year: 2023
bibkey: renrui2023prompt
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2303.02151v1'}]
tags: [Model Architecture, Few Shot, GPT, Prompting, RAG, Training Techniques]
---
