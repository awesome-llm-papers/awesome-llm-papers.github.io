---
layout: publication
title: Improving Visual Grounding With Visual-linguistic Verification And Iterative
  Reasoning
authors: Yang et al.
...
citations: 85
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2205.00272'}]
tags: [Tools, CVPR, Transformer, Model Architecture, Multimodal Models, Datasets]
---
Visual grounding is a task to locate the target indicated by a natural
