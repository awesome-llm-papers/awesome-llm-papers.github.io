...
authors: Yang Jin, Kun Xu, Kun Xu, Liwei Chen, Chao Liao, Jianchao Tan, Quzhe Huang,
  Bin Chen, Chenyi Lei, An Liu, Chengru Song, Xiaoqiang Lei, di Zhang, Wenwu Ou, Kun
  Gai, Yadong Mu
conference: Arxiv
year: 2023
bibkey: yang2023unified
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2309.04669v3'}]
tags: [Multimodal Models, Prompting, Reinforcement Learning, Training Techniques]
---
