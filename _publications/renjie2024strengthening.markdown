...
title: Strengthening Multimodal Large Language Model With Bootstrapped Preference
  Optimization
authors: Renjie Pi, Tianyang Han, Wei Xiong, Jipeng Zhang, Runtao Liu, Rui Pan, Tong
  Zhang
conference: Arxiv
year: 2024
bibkey: renjie2024strengthening
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2403.08730v2'}]
tags: [Multimodal Models, Evaluation, Efficiency And Optimization, Datasets, RAG,
  Ethics And Bias, Training Techniques]
---
