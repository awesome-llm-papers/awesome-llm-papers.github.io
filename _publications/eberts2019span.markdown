...
authors: Eberts Markus, Ulges Adrian
conference: Arxiv
year: 2019
bibkey: eberts2019span
citations: 151
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1909.07755'}]
tags: [Training Techniques, Attention Mechanism, BERT, Transformer, Model Architecture,
  Datasets]
---
We introduce SpERT, an attention model for span-based joint entity and
