...
authors: Olivastri Silvio, Singh Gurkirt, Cuzzolin Fabio
conference: 2019 IEEE Winter Conference on Applications of Computer Vision (WACV)
year: 2019
bibkey: olivastri2019end
citations: 74
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1904.02628'}]
tags: [Training Techniques, Attention Mechanism, Evaluation, Model Architecture, Applications,
