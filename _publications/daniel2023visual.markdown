...
authors: Daniel Rose, Vaishnavi Himakunthala, Andy Ouyang, Ryan He, Alex Mei, Yujie
  Lu, Michael Saxon, Chinmay Sonar, Diba Mirza, William Yang Wang
conference: Arxiv
year: 2023
bibkey: daniel2023visual
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.02317v3'}]
tags: [Multimodal Models, Evaluation, Datasets, Prompting, RAG, Interpretability And
    Explainability]
---
