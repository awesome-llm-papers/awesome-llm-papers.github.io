...
authors: Dmitry Lepikhin, Hyoukjoong Lee, Yuanzhong Xu, Dehao Chen, Orhan Firat, Yanping
  Huang, Maxim Krikun, Noam Shazeer, Zhifeng Chen
conference: Arxiv
year: 2020
bibkey: dmitry2020gshard
citations: 292
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2006.16668v1'}]
tags: [Model Architecture, Transformer, Tools, Alt, Applications, Reinforcement Learning,
  Training Techniques]
---
