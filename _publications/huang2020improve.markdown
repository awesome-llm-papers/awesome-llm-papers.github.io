...
year: 2020
bibkey: huang2020improve
citations: 89
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2009.13658'}]
tags: [Model Architecture, ACL, EMNLP, RAG, Transformer, Attention Mechanism]
---
Transformer architectures rely on explicit position encodings in order to
