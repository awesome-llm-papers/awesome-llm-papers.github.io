...
authors: Xiang Chen, Chenxi Wang, Yida Xue, Ningyu Zhang, Xiaoyan Yang, Qiang Li,
  Yue Shen, Lei Liang, Jinjie Gu, Huajun Chen
conference: Arxiv
year: 2024
bibkey: xiang2024unified
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2402.03190v4'}]
tags: [Multimodal Models, Evaluation, Datasets, Tools, RAG]
---
