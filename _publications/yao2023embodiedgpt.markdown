...
authors: Yao Mu, Qinglong Zhang, Mengkang Hu, Wenhai Wang, Mingyu Ding, Jun Jin, Bin
  Wang, Jifeng Dai, Yu Qiao, Ping Luo
conference: Arxiv
year: 2023
bibkey: yao2023embodiedgpt
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.15021v2'}]
tags: [Model Architecture, Multimodal Models, Evaluation, Agentic, Datasets, Reinforcement
    Learning, GPT, Training Techniques]
---
