...
title: 'Scaling (down) CLIP: A Comprehensive Analysis Of Data, Architecture, And Training
  Strategies'
authors: Li Zichao, Xie Cihang, Cubuk Ekin Dogus
conference: Genome Biology
year: 2024
bibkey: li2024scaling
citations: 77
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2404.08197'}]
tags: [Training Techniques, Model Architecture, Applications, Datasets]
---
