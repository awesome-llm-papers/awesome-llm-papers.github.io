...
citations: 81
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1906.08094'}]
tags: [Model Architecture, TACL, LLM For Code]
---
...
propose an extension of Tree-LSTM, which we call *Multi-way Tree-LSTM* and
