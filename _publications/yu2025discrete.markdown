...
authors: Yu Runpeng, Li Qi, Wang Xinchao
conference: 2023 IEEE International Conference on Big Data (BigData)
year: 2025
bibkey: yu2025discrete
citations: 80
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2506.13759'}]
tags: [Training Techniques, Attention Mechanism, GPT, Tools, Evaluation, Model Architecture,
  Survey Paper, Reinforcement Learning, Applications, Multimodal Models, Datasets,
  Merging]
---
