...
authors: Panigrahi et al.
conference: 2021 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2023
bibkey: panigrahi2023trainable
citations: 1538
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2307.01189'}]
tags: [RAG, Training Techniques, CVPR, In Context Learning, Transformer, Model Architecture,
  Efficiency And Optimization, Language Modeling, Fine Tuning]
---
