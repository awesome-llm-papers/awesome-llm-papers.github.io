...
authors: "Afra Feyza Aky\xFCrek, Ekin Aky\xFCrek, Aman Madaan, Ashwin Kalyan, Peter\
  \ Clark, Derry Wijaya, Niket Tandon"
conference: Arxiv
year: 2023
bibkey: afra2023rl4f
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/2305.08844v2'}]
tags: [Model Architecture, Evaluation, Agentic, Fine Tuning, Datasets, Tools, RAG,
  Reinforcement Learning, GPT, Prompting, Training Techniques]
---
