...
conference: Proceedings of the 2019 Conference on Empirical Methods in Natural Language
  ...
  (EMNLP-IJCNLP)
year: 2019
bibkey: tan2019lxmert
citations: 1978
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1908.07490'}]
tags: [Training Techniques, EMNLP, Attention Mechanism, Masked Language Model, Tools,
  Transformer, BERT, Model Architecture, Language Modeling, Fine Tuning, Multimodal
    Models, Datasets]
---
