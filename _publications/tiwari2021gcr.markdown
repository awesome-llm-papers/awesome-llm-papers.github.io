...
year: 2021
bibkey: tiwari2021gcr
citations: 67
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2111.11210'}]
tags: [RAG, Reinforcement Learning, CVPR, Efficiency And Optimization]
---
Continual learning (CL) aims to develop techniques by which a single model
