...
title: 'Megatron-lm: Training Multi-billion Parameter Language Models Using Model
  Parallelism'
authors: Mohammad et al.
conference: Arxiv
year: 2019
bibkey: mohammad2019megatron
citations: 789
additional_links: [{name: Paper, url: 'http://arxiv.org/abs/1909.08053v4'}]
tags: [Training Techniques, Attention Mechanism, GPT, Tools, Transformer, BERT, Model
    Architecture, Efficiency And Optimization, Language Modeling, Applications, Datasets]
---
